...
//        String unencodedHtml = "<html><body><b>'%23'</b> is the percent code for ‘#‘ </body></html>";
        String unencodedHtml = "<table id=\"example\" class=\"display\" style=\"width:100%\">\n" +
                "        <thead>\n" +
                "            <tr>\n" +
                "                <th>Name</th>\n" +
                "                <th>Position</th>\n" +
...
//        myWebView.loadUrl("https://www.androidworld.it/");
        String scriptTest = "addRow('" + "Test" +"');";
